...
map("n", "<C-p>", [[<cmd>lua require("cloud.project_files").project_files()<cr>]],
    {silent = true})
...
map("n", "<leader>?", [[<cmd>lua require("telescope.builtin").oldfiles()<cr>]],
    {silent = true})
map("n", "<leader>w",
    [[<cmd>lua require("telescope.builtin").grep_string()<cr>]], {silent = true})
map("n", "<leader>fg",
    [[<cmd>lua require("cloud.live_grep").live_grep()<cr>]], {silent = true})
map("n", "<leader>o",
...
map("n", "<leader>gb",
    ...
    {silent = true})
map("n", "<leader>gs",
    [[<cmd>lua require("telescope.builtin").git_status()<cr>]], {silent = true})
map("n", "<leader>gp",
