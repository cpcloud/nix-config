...
local on_attach = function(_, bufnr)
    ...
    map(bufnr, "n", "<leader>e",
        "<cmd>lua vim.lsp.diagnostic.show_line_diagnostics()<CR>", opts)
    map(bufnr, "n", "<leader>p", "<cmd>lua vim.lsp.diagnostic.goto_prev()<CR>",
        opts)
    map(bufnr, "n", "<leader>n", "<cmd>lua vim.lsp.diagnostic.goto_next()<CR>",
        opts)
    map(bufnr, "n", "<leader>q",
        "<cmd>lua vim.lsp.diagnostic.set_loclist()<CR>", opts)

    map(bufnr, "n", "<leader>B",
    ...
    map(bufnr, "n", "<leader>bc",
        [[lua require'dap'.set_breakpoint(vim.fn.input('Breakpoint condition: '))<CR>]],
        opts)
    map(bufnr, "n", "<leader>lp",
...
local prettier_config_files = {
    ".prettierrc", ".prettierrc.json", ".prettierrc.toml", ".prettierrc.json",
    ".prettierrc.yml", ".prettierrc.yaml", ".prettierrc.json5",
...
local servers = {
    "clangd", "pylsp", "texlab", "gopls", "yamlls", "diagnosticls",
    "sumneko_lua",
}
