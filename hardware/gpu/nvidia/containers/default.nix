...
in
{
  # this kernel parameter is necessary because the nvidia container runtime
  # odoesn't support cgroupsv2 :(
  boot.kernelParams = lib.optionals enableNvidiaContainerRuntime [
    "systemd.unified_cgroup_hierarchy=0"
  ];

  environment.systemPackages = lib.optionals enableNvidiaDocker (genScripts "docker")
